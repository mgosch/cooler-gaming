...
<div id="main_content" class="newsColumn">
		...
		<p>El cliente puede solicitar un reembolso de hardware y accesorios de Steam adquiridos a través de Steam sin importar el motivo, siempre que la solicitud esté dentro del periodo de tiempo estipulado en la <a href="https://store.steampowered.com/hardware_order_terms">Política de reembolso de hardware</a>. El cliente debe enviar de vuelta dicho hardware en un plazo máximo de catorce (14) días tras solicitar el reembolso siguiendo las instrucciones facilitadas. La <a href="https://store.steampowered.com/hardware_order_terms">Política de reembolso de hardware</a> contiene más información detallada acerca del proceso de reembolso y cancelación del hardware de Steam y sus accesorios.</p>
		...
		<p>Si quieres saber cómo funciona el derecho de desistimiento europeo para los clientes de Steam, <a href="https://support.steampowered.com/kb_article.php?ref=8620-QYAL-4516">haz clic aquí</a>.</p>
		...
		<p>Puedes solicitar un reembolso u otro tipo de asistencia con tus compras de Steam en <a href="https://help.steampowered.com">help.steampowered.com</a>.</p>
